// /core/thumbnail/createClientThumbnail.ts

export async function createClientThumbnail(file: File): Promise<Blob> {
    ...
    if (!ctx) throw new Error("Thumbnail canvas context missing");
